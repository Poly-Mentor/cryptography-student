...
using block = std::array<word_t, 16>;
...
class MD5
{
    ...
    private:
        ...
        // k-table: value of i-th element is equal to floor(2^32 * abs(sin(i + 1)))
        // precomputed for better performance
        inline static constexpr word_t k[64] = 
        {
        ...
        // r-table: value of i-th element is equal to the number of bits to rotate in i-th iteration
        inline static constexpr uint8_t r[64] =
        {
